  ...
  navbarPage(
    ...
    tabPanel("Run GSOA",
      ...
      column(  4, offset = 1, 
        ...
        div( style = "height: 65px;", textInput('results_h',value = "",width = "70%",label = 'E-mail Address'  )),
        br(),
        # more hidden stuff  
        ...
        div( style = "height: 85px;", numericInput('Iterations', label = 'Number of Iterations.',value = 1000, min = 1,width = "70%",max = 1000)) )),
        br(),
        br(),
